...
<script type="text/javascript">
	...
	function submitForm(){
		...
		//1得到js对象
		var paramJson = [];
		$("#itemeEditForm .params li").each(function(i,e){//获取输入内容
			var trs = $(e).find("tr");
		...
		paramJson = JSON.stringify(paramJson);//2转成json字符串
		
		$("#itemeEditForm [name=itemParams]").val(paramJson);//3放到隐藏表单
		
		//提交到后台的RESTful
		$.ajax({
		   type: "PUT",
		   url: "/rest/item",
		   data: $("#itemeEditForm").serialize(),//表单序列化
		   statusCode:{
			   204:function(){
				   $.messager.alert('提示','修改商品成功!','info',function(){
						$("#itemEditWindow").window('close');
						$("#itemList").datagrid("reload"); //修改成功后进行页面刷新
					});
			   },
			   400:function(){
